package com.ziiwee.support.wechat2.util;
...
public class HttpRequestUtil {
     ...
     * @return
     */
    public static String post(String url, String textParameters) {
        return request(Method.POST, ContentType.X_WWW_FORM_URLENCODED, url, textParameters);
    }
